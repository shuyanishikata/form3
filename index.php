...
let pdf = document.getElementById("コメント");
    ...
    // let pdf1 = document.getElementById('order1');
    // let pdf2 = document.getElementById('order2');


    // $("#menu42").on("click", function () {
    //     $("#order1").css("width", "500px");
    //     pdf1.setAttribute('value', "ｗｗｗｗ" );
    //     $("#コメント").text("あああ！");
    // });
